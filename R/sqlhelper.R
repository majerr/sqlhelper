...
#'
#' \item{\strong{It provides functions which return useful sql snippets}.}{For example,
#' for use in a SQL \code{WHERE} clause to extract an \code{n} percent sample
#' from a table. See, \code{\link{nthofk}}.}
#'
#' }
#'
...
#'
#'   For data wrangling, you probably want to write your SQL queries in their
#'   own files. Then you will want to use \code{runfiles}:
#'
#'   \preformatted{
#'
#'   # load ucsqlhelper
...
#'   # Names in the outer list are the
#'   # filenames, stripped of path and extension:
...
#'
#'   # queries that do not return a result (e.g.
#'   # CREATE TABLE) will result in an empty list. }
#'
